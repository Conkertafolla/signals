...
int main(int argc, char *argv[]) {
    ...
    char *filename = argv[1] ;//"C:\\Users\\Josimar\\Documents\\Señales\\práctica1-reducirvolumen\\sen1.wav";
	char *filename2 = argv[2] ;//"C:\\Users\\Josimar\\Documents\\Señales\\práctica1-reducirvolumen\\Salidap1.wav";
